...
async function main() {
  console.log('🌱 Starting Project Lenta database seed...');
  ...
  // 3. Create Chronological Notes with Raw Markdown
  const notesData = [
    {
      feedId: feedMcu.id,
...
- Materialized path tree builder with fast Ltree indexing.`,
  ...
  console.log(`✅ Created ${notesData.length} Notes with diverse NoteTypes and Markdown`);
