...
export const createNoteSchema = z.object({
  ...
  resonanceScore: z.number().int().min(0).max(100).optional().nullable(),
...
export const queryNotesSchema = z.object({
  ...
  minResonance: z.number().int().min(0).max(100).optional(),
...
export const frontmatterSchema = z.object({
  ...
  resonance_score: z.number().optional().nullable(),
  parent_note_id: z.string().optional().nullable(),
