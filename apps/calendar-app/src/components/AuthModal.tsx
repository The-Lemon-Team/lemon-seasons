...
import { X, Lock, Mail, User, ShieldCheck, UserCheck, Eye, ArrowRight, Sparkles } from 'lucide-react';
...
export const AuthModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div
        className="relative w-full max-w-lg bg-[#181a1a] border border-[#2d3030] rounded-xl shadow-2xl overflow-hidden flex flex-col"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#242828] bg-[#121414]/70">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-sans font-bold text-sm text-[#e5e971]">
                {tab === 'login' ? t.loginModalTitle : t.registerModalTitle}
              </h3>
              <p className="text-[11px] font-mono text-[#93927e]">
                Lemon Calendarium Access Tier
              </p>
            </div>
          </div>
          <button
