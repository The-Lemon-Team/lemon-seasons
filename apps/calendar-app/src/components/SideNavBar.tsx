...
export const SideNavBar: React.FC<SideNavBarProps> = ({
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-[#1e2020] border-r border-[#242828] flex flex-col py-6 px-4 gap-2 z-40 hidden md:flex transition-all duration-200 ease-in-out">
      ...
      {/* Footer Meta */}
      <div className="mt-auto pt-4 border-t border-[#242828] flex flex-col gap-1 text-[11px] font-mono text-[#c9c7b2]">
        <div className="flex items-center justify-between px-2 py-1">
          <span>Version</span>
          <span className="text-[#e5e971]">v2.0.0</span>
        </div>
        <div className="flex items-center justify-between px-2 py-1">
          <span>Engine</span>
          <span className="text-neutral-400">Lenta LWW</span>
        </div>
      </div>
    </aside>
  );
