    ...
    <div className="flex-1 flex flex-col h-full overflow-y-auto bg-[#121414] text-[#e2e2e2] px-4 lg:px-8 py-6 selection:bg-[#8b5cf6]/30 selection:text-[#d8b4fe]">
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div
            className="relative w-full max-w-2xl bg-[#181a1a] border border-[#a855f7]/40 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#242828] bg-[#141616]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-sans font-bold text-base text-[#f3e8ff]">
                    {t.newContainerTitle}
                  </h3>
                  <p className="text-[11px] font-mono text-[#93927e]">
                    Создание хранилища с выбором приватности и отслеживаемых папок
                  </p>
                </div>
              </div>
              <button
      ...
      {isGuideModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div
            className="relative w-full max-w-2xl bg-[#181a1a] border border-[#2d3030] rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#242828] bg-[#141616]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-sans font-bold text-sm text-[#f3e8ff]">
                    {t.pluginInstructionsTitle}
                  </h3>
                  <p className="text-[11px] font-mono text-[#93927e]">
                    Lemon Lenta Plugin • Двусторонняя синхронизация Markdown
                  </p>
                </div>
              </div>
              <button
                onClick={() => setIsGuideModalOpen(false)}
                className="p-1 rounded-md text-[#93927e] hover:text-white hover:bg-[#242828]"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
